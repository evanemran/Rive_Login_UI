...
import 'package:rive_login/style.dart';
import 'package:rive_login/teddy_controller.dart';
import 'package:rive_login/tracking_text_input.dart';
...
class LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        centerTitle: true, title: const Text("Login", style: TextStyle(color: Colors.white, fontSize: 20),),),
      body: Container(
        height: height,
